    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>Tambah Lokasi Perusahaan</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.company-locations.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('type') is-invalid @enderror" name="type" id="type" required>
                                    <option value="headquarters" {{ old('type') == 'headquarters' ? 'selected' : '' }}>Kantor Pusat</option>
                                    ...
                                    <option value="workshop" {{ old('type') == 'workshop' ? 'selected' : '' }}>Workshop / Bengkel</option>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('city') is-invalid @enderror" type="text" name="city" id="city" value="{{ old('city') }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('province') is-invalid @enderror" type="text" name="province" id="province" value="{{ old('province') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('phone') is-invalid @enderror" type="text" name="phone" id="phone" value="{{ old('phone') }}" placeholder="Kosongkan untuk pakai nomor utama">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('whatsapp') is-invalid @enderror" type="text" name="whatsapp" id="whatsapp" value="{{ old('whatsapp') }}" placeholder="Kosongkan untuk pakai WA utama">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('google_maps_url') is-invalid @enderror" type="url" name="google_maps_url" id="google_maps_url" value="{{ old('google_maps_url') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('business_hours') is-invalid @enderror" type="text" name="business_hours" id="business_hours" value="{{ old('business_hours') }}" placeholder="Senin - Jumat, 08:00 - 17:00">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control @error('sort_order') is-invalid @enderror" type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', 0) }}">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn bg-gradient-primary m-0">Simpan Lokasi</button>
                    </div>
                </form>
            </div>
        </div>
